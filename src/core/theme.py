...
DEFAULT_THEME_SPEC: dict[str, Any] = {
    "ui": {
        ...
        "bracket_level_2": {"fg": "#4cc9f0", "bold": True},
        "bracket_level_3": {"fg": "#ffd166", "bold": True},
        "bracket_level_4": {"fg": "#06d6a0", "bold": True},
        "bracket_level_5": {"fg": "#f472b6", "bold": True},
        "bracket_level_6": {"fg": "#a78bfa", "bold": True},
        "bracket_level_7": {"fg": "#fb923c", "bold": True},
        "bracket_level_8": {"fg": "#84cc16", "bold": True},
